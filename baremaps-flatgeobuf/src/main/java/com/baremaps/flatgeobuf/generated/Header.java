...
package com.baremaps.flatgeobuf.generated;
...
public final class Header extends Table {
  ...
  public static void addEnvelope(FlatBufferBuilder builder, int envelopeOffset) {
    builder.addOffset(1, envelopeOffset, 0);
  }

  public static int createEnvelopeVector(FlatBufferBuilder builder, double[] data) {
  ...
  public static void addGeometryType(FlatBufferBuilder builder, int geometryType) {
  ...
  public static void addFeaturesCount(FlatBufferBuilder builder, long featuresCount) {
    builder.addLong(8, featuresCount, 0L);
  }

  public static void addIndexNodeSize(FlatBufferBuilder builder, int indexNodeSize) {
  ...
  public static void finishSizePrefixedHeaderBuffer(FlatBufferBuilder builder, int offset) {
